...
description: A summary of a paper on conclusions drawn from cross-lagged models
keywords: Continuous-Time, longitudinal data, unequal lags, Structural Equation Modeling, SEM, dynamic models, meta-science, granger 
---
