...
![Stable Non-Oscillating Bivariate Example](/images/Effects-lag-plot_Bivar.jpg "Stable Non-Oscillating Bivariate Example")

For a more detailed description of eigenvalues and how they relate to the *behaviour* of systems,  I recommend reading our book chapter which discusses CT models and ESM data, [pre-print available here](https://ryanoisin.github.io/files/RyanKuiperHamaker_2018_chapter_preprint.pdf).
